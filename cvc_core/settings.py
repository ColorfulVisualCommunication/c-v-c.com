"""
Django settings for cvc_core project.
...
SECRET_KEY = 'django-insecure-x$vn0gb#7fd0%0jpj3&@vu5ccxow88jr(lsog9=)lly_*3b=ep'
...
WSGI_APPLICATION = 'cvc_core.wsgi.application'
